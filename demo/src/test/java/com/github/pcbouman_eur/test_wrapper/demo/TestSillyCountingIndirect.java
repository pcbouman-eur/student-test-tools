...
public class TestSillyCountingIndirect {

    // We define an interface SillyCountingInterface and declare a WrapperFactory here
    public static WrapperFactory<SillyCountingInterface, SillyCounting> fac =
            new WrapperFactory<>(SillyCountingInterface.class, SillyCounting.class);
