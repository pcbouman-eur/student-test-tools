...
public class TestPrimeGeneratorIndirect {

    // We define a PrimeInterface and declare a WrapperFactory here
    private static final WrapperFactory<PrimeInterface,PrimeGenerator> fac = new
            WrapperFactory<>(PrimeInterface.class, PrimeGenerator.class);
