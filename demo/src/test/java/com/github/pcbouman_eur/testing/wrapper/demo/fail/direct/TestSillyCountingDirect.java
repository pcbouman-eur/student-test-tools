...
package com.github.pcbouman_eur.testing.wrapper.demo.fail.direct;
...
public class TestSillyCountingDirect {
    ...
    {
        EmptyClass sc = new EmptyClass(start);
    ...
    public void testMultiInstance() {
        ...
        EmptyClass sc1 = new EmptyClass(1);
        answer1.add(sc1.getNextCount());
        EmptyClass sc2 = new EmptyClass(9);
